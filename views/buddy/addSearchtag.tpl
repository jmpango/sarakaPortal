    	...
    	<div class="panel">
    		...
    		<div class="content layout">
    			<div class="breadcrumb">
    				...
    				<span class="arrow"></span>
    				<span class="text"><a href="<?php echo BASEURL;?>/buddy/listing/searchtag/<?php echo $buddy->getId();?>">Searchtag Listing</a></span>
    				<span class="arrow"></span>
    				<span class="text">Add  </span>
    			</div>
    			<div style="clear: both;"></div>
					<div class="formTable">
    				<form action="<?php echo BASEURL;?>/buddy/listing/saveSearchtag/<?php echo $buddy->getId();?>" method="post" >
    							<p>
    								...
    								<input style="margin-left: 50px;"  type="text" name="searchtag" value="<?php if(isset($saveForm)) echo $saveForm['searchtag'];else echo @$searchtag;?>"><br>
    							</p>
    							<p>
    								<span>Status: </span>
