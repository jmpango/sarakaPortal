...
self::$db->query("CREATE TABLE IF NOT EXISTS buddy_image(id INT PRIMARY KEY AUTO_INCREMENT, image_name VARCHAR(255), image_small BLOB NOT NULL, image_meduim BLOB NOT NULL, image_large BLOB NOT NULL, image_xlarge BLOB NOT NULL, buddy_id INT, FOREIGN KEY(buddy_id) REFERENCES buddy(id))");
